...
from datasets import render_dataset_widget
...
def render_chapter_2():
    ...
    # Add interactive widgets at the end of the chapter
    st.markdown("---")
    
    col1, col2 = st.columns(2)
    
    with col1:
        render_exercise_widget("chapter2")
    
    with col2:
        render_dataset_widget("chapter2")
